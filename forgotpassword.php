...
<!-- End Matomo Code -->
	...
	<body class="landing is-preload">
		...
		<!-- Page Wrapper -->
			...
			<a href="forgotpassword.php" style="text-decoration: hidden !important;"><h3 style="text-align:center; padding-top:12px;">Forgot Password</h3></a>
						<nav id="nav">
							<ul>
								<li class="special">
...
?>
<form method="post" name="forgot" action="forgot_pwd.php">
